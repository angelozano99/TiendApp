...
public class controladorContabilidad implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == this.vistaContabilidad.ComboBox) {
            Object filtro = this.vistaContabilidad.ComboBox.getSelectedItem();
            
            if (filtro.equals("Diaria")) {
                
            }else if(filtro.equals("Semanal")){
                
            }else if(filtro.equals("Mensual")){
